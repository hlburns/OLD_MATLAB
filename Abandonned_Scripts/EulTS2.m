function [TS]=EulTS2(Nyrs1,Nyrs5,start,stop)
%% Eularian Stream function timeseries
% This function finds the absolute maximum at a point (no zonal mean)
...
for i=start:5:stop %5 year dumps  
    ...
    PsiEul=MOCcalc2(Y,T,Psi); %Call my MOCcalc function
...
print('-deps','Eulerian_Mean_timeseries3')
end